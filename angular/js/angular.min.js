...
(function( Q, S, s ){
    ...
    function $( b, a ){
        ...
        if( a ){
            ...
            (a = b) && (K( b ) ? a = $( b, [] ) : Ka( b ) ? a = new Date( b.getTime() ) : $a( b ) ? a = RegExp( b.source ) : X( b ) && (a = $( b, {} )));
        }
        return a
    }
    ...
    function dd( b, a, c, d ){
        ...
        h.cookies = function( a, b ){
            ...
            if( a ){
                b ===
                s ? m.cookie = escape( a ) + "=;path=" + ba + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : D( b ) && (d = (m.cookie = escape( a ) + "=" + escape( b ) + ";path=" + ba).length + 1, 4096 < d && c.warn( "Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!" ));
            } else{
            ...
            "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function( a, b, l, n, p, r, E, z, F, u, R, H ){
                ...
                function ga( a, c, d, e, g, f, m, n, p ){
                    ...
                    for( var T = !1, B = !1, y = d.$$element = A( c ), G, ca, t, Q = e, P, M = 0, ma = a.length; M < ma; M++ ){
                        ...
                        if( t = G.transclude ){
                            T = !0, G.$$tlb || (v( "transclusion", p, G, y ), p = G), "element" == t ? (B = !0, N = G.priority, t = ba( c, Va, U ),
                        ...
                        if( G.template ){
                            if( v( "template", ga, G, y ), ga = G, t = L( G.template ) ? G.template( y, d ) : G.template, t = W( t ), G.replace ){
                                f = G;
                        ...
                        if( G.templateUrl ){
                            v( "template", ga, G, y ), ga = G, G.replace && (f = G), F = w( a.splice( M, a.length - M ), y, d, g, Q, m, n, {
                ...
                function T( b, e, g, f, k, r, n ){
                    ...
                    if( c.hasOwnProperty( e ) ){
                        ...
                        for( var E = 0, z = e.length; E < z; E++ )try{
                            p = e[E], (f === s || f > p.priority) && -1 != p.restrict.indexOf( g ) && (r && (p = Qb( p, {
                                $$start: r,
                                $$end: n
                            } )), b.push( p ), k = p)
                        } catch( R ){
                ...
                function w( a, b, c, d, e, g, f, k ){
                    var m = [], r, l, E = b[0], z = a.shift(), R = y( {}, z, {
                        templateUrl: null,
                        transclude: null,
                        replace: null,
                        $$originalDirective: z
                    } ), x = L( z.templateUrl ) ? z.templateUrl( b, c ) : z.templateUrl;
                    b.empty();
                ...
                function hb( a, b, c ){
                    ...
                    if( a ){
                        for( f = 0, m = a.length; f < m; f++ )if( a[f] == d ){
                            a[f++] = c;
                            m = f + e - 1;
        ...
        this.$get =
            ["$parse", "$exceptionHandler", "$sce", function( c, d, e ){
                function g( g, k, l ){
                    ...
                    if( !k || F ){
                        return u.length = z, r = function( a ){
                            try{
                        ...
                        a:do{
                            if( h = N.$$watchers ){
                                for( q = h.length; q--; )try{
                                    if( d = h[q] ){
                                        if( (f = d.get( N )) !== (g = d.last) && !(d.eq ? ta( f, g ) : "number" == typeof f && "number" == typeof g && isNaN( f ) && isNaN( g )) ){
                                            x = !0, c = d, d.last = d.eq ? $( f ) : f, d.fn( f, g === n ? f : g, N ), 5 > s && (J = 4 - s, V[J] ||
                                            (V[J] = []), t = L( d.exp ) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, t += "; newVal: " + pa( f ) + "; oldVal: " + pa( g ), V[J].push( t ));
                                        } else if( d === c ){
                                            x = !1;
                                            break a
                                        }
            ...
            return {
                trustAs: function( a, b ){
                    ...
                    if( c === ea.RESOURCE_URL ){
                        ...
                        if( p ){
                            for( l = 0, n = a.length; l < n; l++ )if( "self" === a[l] ? Eb( g ) : a[l].exec( g.href ) ){
                                p = !1;
                                break
                            }
                        }
    ...
    var Tc = /[A-Z]/g, Rd = {
        ...
        }, Ra = P.cache = {}, db = P.expando = "ng-" + (new Date).getTime(),
        ...
        }, Vc = /([\:\-\_]+(.))/g, Wc = /^moz([A-Z])/, wb = t( "jqLite" ), Fa = P.prototype = {
            ready: function( b ){
                function a(){
                    c || (c = !0, b())
                }
    ...
    q( {
        data: bc, inheritedData: eb, scope: function( b ){
            ...
            } else if( C( c ) )b.setAttribute( a, c ); else if( b.getAttribute )return b = b.getAttribute( a, 2 ), null === b ? s : b
        }, prop: function( b, a, c ){
    ...
    Jb.prototype = {
        constructor: Jb, lex: function( a ){
            ...
            for( var d = "", e = a, g = !1; this.index < this.text.length; ){
                ...
                if( g ){
                    "u" === f ? (f = this.text.substring( this.index + 1, this.index + 5 ), f.match( /[\da-f]{4}/i ) || this.throwError( "Invalid unicode escape [\\u" +
    ...
    var Ib = {}, ra = t( "$sce" ), ea = {
        ...
        JS: "js"
    }, U = S.createElement( "a" ), zc = xa( Q.location.href, !0 );
    Ac.$inject = ["$provide"];
    Bc.$inject = ["$locale"];
    Dc.$inject = ["$locale"];
    var Gc = ".", Pd = {
            ...
            transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function( e, g, f, h, m ){
                ...
                e.$watchCollection( h, function( a ){
                    ...
                    for( f = 0; f < h; f++ )if( B = a ===
                        T ? f : T[f], D = a[B], D = n( B, D, f ), wa( D, "`track by` id" ), C.hasOwnProperty( D ) ){
                        w = C[D], delete C[D], u[D] = w, v[f] = w;
                    } else{
                        if( u.hasOwnProperty( D ) ){
                            throw q( v, function( a ){
                                a && a.scope && (C[a.id] = a)
                            } ), d( "dupes", k, D );
                        }
                        v[f] = {id: D};
                ...
                function n( e, f, g ){
                    function h(){
                        ...
                        for( B = c.length; I < B; I++ ){
                            ...
                            F = null;
                            v = 0;
                            for( E = k.length; v < E; v++ )s = k[v], (d = x[v + 1]) ? (F = d.element, d.label !== s.label && F.text( d.label = s.label ), d.id !== s.id && F.val( d.id = s.id ), F[0].selected !== s.selected && F.prop( "selected", d.selected = s.selected )) : ("" === s.id && z ? H = z : (H = u.clone()).val( s.id ).attr( "selected", s.selected ).text( s.label ), x.push( {
                                element: H,
                                label: s.label,
                                id: s.id,
                                selected: s.selected
                            } ), F ? F.after( H ) : t.element.append( H ), F = H);
                    ...
                    f.on( "change", function(){
                        e.$apply( function(){
                            ...
                            if( r ){
                                for( k = [], p = 0, u = y.length; p < u; p++ )for( a = y[p], l = 1, t = a.length; l < t; l++ ){
